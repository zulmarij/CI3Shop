...
<head>
    ...
    <title>Login - Codeigniter Shop</title>
                    ...
                    <div class="card-body">
                       <form action="">
                           <div class="form-group">
                               ...
                               <small class="from-text text-danger">E-Mail harus diisi</small>
                           </div>
                           <div class="form-group">
                               <label for="">Password</label>
                               <input type="password" class="form-control" required>
                               <small class="from-text text-danger">Password harus diisi</small>
                           </div>
